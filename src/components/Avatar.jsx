...
export function Avatar(props) {
  ...
  const {headFollow,cursorFollows,wireframe} = useControls({
    headFollow: false,
    cursorFollows: false,
    wireframe:false,
  })
  const group = useRef();
  const { nodes, materials } = useGLTF('models/664f0be936908571b1e78d74.glb')
...
useGLTF.preload('models/664f0be936908571b1e78d74.glb')
